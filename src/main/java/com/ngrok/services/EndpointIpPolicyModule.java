...
/**
 * An API client for {@link EndpointIpPolicyModule}.
 */
public class EndpointIpPolicyModule {
     ...
     */
    public EndpointIpPolicyModule(final NgrokApiClient apiClient) {
     ...
     */
    public class EndpointIpPolicyModuleReplaceCallBuilder {
        private final String id;
        private EndpointIpPolicyMutate module = null;

        private EndpointIpPolicyModuleReplaceCallBuilder(
            final String id
        ) {
         ...
         */
        public EndpointIpPolicyModuleReplaceCallBuilder module(final EndpointIpPolicyMutate module) {
         ...
         * @return the call builder instance
         */
        public EndpointIpPolicyModuleReplaceCallBuilder module(final Optional<EndpointIpPolicyMutate> module) {
        ...
        public CompletionStage<EndpointIpPolicy> call() {
            return apiClient.sendRequest(
                ...
                "/endpoint_configurations/" + this.id + "/ip_policy",
                Stream.empty(),
                Stream.of(
     ...
     */
    public EndpointIpPolicyModuleReplaceCallBuilder replace(
        final String id
    ) {
        return new EndpointIpPolicyModuleReplaceCallBuilder(
            id
        );
    }
     ...
     */
    public class EndpointIpPolicyModuleGetCallBuilder {
        private final String id;

        private EndpointIpPolicyModuleGetCallBuilder(
            final String id
        ) {
            this.id = Objects.requireNonNull(id, "id is required");
        }
     ...
     * @return a call builder for this API call
     */
    public EndpointIpPolicyModuleGetCallBuilder get(
        final String id
    ) {
        return new EndpointIpPolicyModuleGetCallBuilder(
            id
        );
    }
     ...
     */
    public class EndpointIpPolicyModuleDeleteCallBuilder {
        private final String id;

        private EndpointIpPolicyModuleDeleteCallBuilder(
            final String id
        ) {
            this.id = Objects.requireNonNull(id, "id is required");
        }
     ...
     * @return a call builder for this API call
     */
    public EndpointIpPolicyModuleDeleteCallBuilder delete(
        final String id
    ) {
        return new EndpointIpPolicyModuleDeleteCallBuilder(
            id
        );
    }
}
