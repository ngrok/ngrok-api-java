...
public class Tunnel {
     ...
     * @param metadata user-supplied metadata for the tunnel defined in the ngrok configuration file. See the tunnel <a href="https://ngrok.com/docs/secure-tunnels/ngrok-agent/reference/config#common-tunnel-configuration-properties">metadata configuration option</a> In API version 0, this value was instead pulled from the top-level <a href="https://ngrok.com/docs/secure-tunnels/ngrok-agent/reference/config#metadata">metadata configuration option</a>.
     ...
     * See the tunnel <a
     * href="https://ngrok.com/docs/secure-tunnels/ngrok-agent/reference/config#common-tunnel-configuration-properties">metadata
     * configuration option</a> In API version 0, this value was instead pulled from
     * the top-level <a
     * href="https://ngrok.com/docs/secure-tunnels/ngrok-agent/reference/config#metadata">metadata
