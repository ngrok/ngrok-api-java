...
/**
 * A class encapsulating the {@link KubernetesOperatorBindingCreate} resource.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class KubernetesOperatorBindingCreate {
    /**
     * Builder class for {@link KubernetesOperatorBindingCreate}.
     */
    public static class Builder {
        private java.util.List<String> endpointSelectors = java.util.Collections.emptyList();
        ...
        public Builder endpointSelectors(final Optional<java.util.List<String>> endpointSelectors) {
            this.endpointSelectors = Objects.requireNonNull(endpointSelectors, "endpointSelectors is required").orElse(java.util.Collections.emptyList());
            return this;
        }
        ...
        /**
         * Constructs the {@link KubernetesOperatorBindingCreate} instance.
         *
         * @return a new {@link KubernetesOperatorBindingCreate}
         */
        public KubernetesOperatorBindingCreate build() {
            return new KubernetesOperatorBindingCreate(
    ...
    /**
     * Creates a new builder for the {@link KubernetesOperatorBindingCreate} type.
     *
    ...
    /**
     * Creates a new instance of {@link KubernetesOperatorBindingCreate}.
     *
     ...
     */
    @JsonCreator
    private KubernetesOperatorBindingCreate(
    ...
    public boolean equals(final Object o) {
        ...
        final KubernetesOperatorBindingCreate other = (KubernetesOperatorBindingCreate) o;
        return
    ...
    public String toString() {
        return "KubernetesOperatorBindingCreate{" +
